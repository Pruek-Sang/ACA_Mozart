...
/**
 * ContextPanel - แผงควบคุมค่าเงื่อนไขทางเทคนิค
 * 
...
export const ContextPanel: React.FC<ContextPanelProps> = ({
    ...
    return (
        <div className="bg-slate-950 border-r border-slate-800 flex flex-col">
            {/* Header */}
            <div className="p-3 border-b border-t border-slate-800 flex justify-between items-center bg-slate-900">
